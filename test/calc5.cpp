/*
 * @Author: Elendeer
 * @Date: 2020-05-28 18:59:24
 * @LastEditors: Elendeer
 * @LastEditTime: 2020-05-29 15:09:10
...
enum TokenType { // define enum type to record the type of a token.
    NONE, INTEGER, MUL, DIV, PLUS, MINUS, eEOF
};
const string getStringFromEnum[] = {"NONE", "INTEGER", "MUL", "DIV", "PLUS", "MINUS", "EOF"};
